...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.upload.setGeometry(QtCore.QRect(30, 160, 161, 51))
        self.upload.setObjectName("upload")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(30, 340, 141, 41))
        self.lineEdit.setObjectName("lineEdit")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(30, 270, 161, 51))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Predicted Number"))
